...
.. parsed-literal::
    ...
    \/\*\*
     ...
     \*
     \* @scale\:      Filled with enum :c:type:`fecap_scale_params` - the scale
     \*              in usage for that parameter
     \*
     \* The \`\`\{unnamed\_union\}\`\` may have either one of the values below\:
     \*
     \* \%svalue
    ...
    \/\*\*
     ...
     \* \%st
     \*      a \&struct :c:type:`dtv_fe_stats` array of statistics.
     \* \%buffer
